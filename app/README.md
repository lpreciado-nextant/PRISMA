...
**Status:** Connected video fallback notice deployed and hosted-verified; submission, return/revision, publication and present-mode workflow passed with one privileged account. Non-admin and separate-reviewer acceptance remain open.

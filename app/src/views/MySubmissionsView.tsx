    ...
    {!entries.length ? <div className="py-20 text-center">
      ...
      {entries.map(({ solution }, index) => <article key={solution.id} className="min-w-0">
        ...
        <div className="mt-3 flex flex-wrap items-center justify-between gap-3">
          <span className="text-[13px]" style={{ color: solution.publicationStatus === "Published" ? "var(--live)" : "var(--proto)" }}>{solution.publicationStatus === "Draft" && solution.reviewOutcome === "Changes requested" ? "Changes requested" : solution.publicationStatus}</span>

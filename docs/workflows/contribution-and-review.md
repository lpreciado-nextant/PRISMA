...
**Status:** Eight-area single-account acceptance pass recorded; retirement/concurrency verified, external URL and browser delivery/playback blockers remain · **Last updated:** 2026-09-22
...
| 7. External launches | Blocked | The approved real MyPortal URL (163 characters) failed the protected save twice with Dataverse `0x80090429` truncation on `nx_ExternalURL`, although published and editable metadata both report MaxLength=4000. No schema change was made. Short URL contract tests do not establish real app URL support. Direct MyPortal navigation previously loaded signed in, but PRISMA-to-target launch remains unverified. No Power BI report URL was supplied. |

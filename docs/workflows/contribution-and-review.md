...
**Status:** Local submission flow includes confirmed owner-only deletion, required authored draft names, dedicated review fields and state-dependent completeness; production transitions specified, not implemented · **Last updated:** 2026-09-21

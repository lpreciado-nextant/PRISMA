...
**Status:** Agreed design; eight-area single-account checks recorded; real-URL persistence, delivery/playback and least-privilege acceptance remain open

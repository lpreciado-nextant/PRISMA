...
| **3 — Present mode** | Client-safe restriction, redaction, presentation chrome. **Gated behind a deliberate review of shareability flags on every published record** | G3 safety | Not started |
